...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "A Ruby gem for calculating planetary positions and house cusps using Swiss Ephemeris."
  spec.description   = "Astrarium provides tools for calculating planetary signs, house cusps, and planet-to-house placements using swe4r (Swiss Ephemeris wrapper)."
